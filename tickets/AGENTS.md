# Tickets Service Documentation Instructions

## Scope

- Tickets service source is referenced as `@tickets`.
...
- The only permitted file edit for this documentation task is `@tickets/README.md`.
- Read any existing `@tickets/README.md` before editing it.
...
- Use `@tickets`-style paths in README documentation where practical.
...
- Database models, ticket persistence, and concurrency/versioning behavior when present.
